...
const Info2: React.FC = () => {
  ...
  return (
    <div
      id="info2"
      style={bgStyle}
      className="h-full md:h-screen text-[#e8e7e7] z-10 flex-col justify-center "
    >
      {/* container */}
      ...
      <div className="md:hidden w-full bg-[#191a1e] p-4 flex mx-auto flex-col justify-center">
