    ...
    <div className="fixed w-full h-[80px] flex justify-between items-center px-4 bg-transparent text-gray-300 z-50">
      ...
      <ul className="hidden md:flex gap-3 font-semibold">
        ...
        <div className="flex">
          <button
            id="switch-btnEn"
            className="flex justify-between px-2 hover:text-[#3CD6EB]"
          ...
          <button
            id="switch-btnFi"
            className="hover:text-[#3CD6EB]"
            onClick={() => handleLanguageChange('fi')}
          >
            {t('FI')}
          </button>
        </div>
        <li className="hover:text-[#3CD6EB]">
          <a href="/">DEV</a>
        </li>
        <li className="hover:text-[#3CD6EB]">
          <Link to="wordpress" smooth={true} duration={500}>
            {t('wpHeader')}
          </Link>
        </li>
        <li className="hover:text-[#3CD6EB]">
      ...
      <ul
        className={
          !nav
            ? 'hidden'
            : 'absolute top-0 left-0 w-full h-screen bg-[#191a1e] text-[#e8e7e7] flex flex-col justify-center items-center z-20'
        }
      >
        {/*language handler*/}
        <div className="flex">
