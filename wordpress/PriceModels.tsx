    ...
    >
      ...
      <div className=" mx-auto p-4 pt-10 flex flex-col justify-center w-full">
        <div className="max-w-[1000px] flex flex-col align-middle mx-auto">
          ...
          <div className="w-full grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4 text-center py-8">
            {/* Info-container */}
            <div
            ...
            >
              ...
              <ul className="my-4 text-lg font-medium text-slate-100 border-t-4 border-orange-400 pt-4">
                <li>
                  <p>{t('infoL1')}</p>
                </li>
                <li>{t('infoL2')}</li>
